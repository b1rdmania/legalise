...
reusability test — Contract Review covered single-doc
single-artifact and the substrate's
``test_different_kinds_on_same_invocation_allowed`` proved the
substrate could carry multi-artifact at the storage level; this
module is the first real reference module to use it.
