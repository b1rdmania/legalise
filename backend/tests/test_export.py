...
class TestBuildMatterExportUnit:
    ...
    async def test_zip_contains_required_files(self) -> None:
        ...
        try:
            ...
            # When v0.5 expands the export (chronology, document bodies,
            # versions, generated bytes, citations, tabular reviews,
            # assistant messages), this test should be updated alongside
            # the wider zip contents and the docstring in app/core/exports.py.
            out_of_scope_for_v04 = {
                "chronology.json",
            ...
            present_out_of_scope = names & out_of_scope_for_v04
            assert not present_out_of_scope, (
                f"v0.4 narrowed export should not include {present_out_of_scope}; "
