        ...
        {expected.map((e) => {
          ...
          return (
            ...
            >
              ...
              <div className={`text-xs tech-token font-bold ${colour}`}>
                {status === "running" && (
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="border-t border-rule">
          <div className="grid grid-cols-[1fr_80px_100px_100px_80px] gap-4 px-4 py-2 text-muted bg-paper border-b border-rule tech-token uppercase tracking-track2 text-[9px]">
            <span>Stage</span>
            <span>Calls</span>
            <span>Duration</span>
            <span>Tokens</span>
          ...
          {result.stages.map((s) => (
            <div
              key={s.name}
              className="grid grid-cols-[1fr_80px_100px_100px_80px] gap-4 px-4 py-3 border-b border-rule tech-token text-[11px] items-center"
            >
